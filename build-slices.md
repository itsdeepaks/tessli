...
- V3.2 completed the AccessRoute contract pilot, V3.3 completed the Motion source-guide proof, V3.4 focused canonical Browse, and V3.5 completed the homepage task entry; V3.6–V3.17 are the remaining ordered delivery sequence.
...
| V3.6  | Resource-card consistency         | NEXT     | V3.3, V3.4              |
