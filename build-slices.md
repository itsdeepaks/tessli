...
Status: **active delivery plan — V3.14 For AI redesign NEXT**
...
- V3.2 completed the AccessRoute contract pilot, V3.3 completed the Motion source-guide proof, V3.4 focused canonical Browse, V3.5 completed the homepage task entry, V3.6 completed resource-card consistency, V3.7 completed deterministic task retrieval, V3.8 completed local MCP v2, V3.9 completed compact public machine representations, V3.10 completed machine discovery, V3.11 completed Collections as research paths, V3.12 completed Saved-to-Board flow, and V3.13 completed Board agent handoff; V3.14–V3.17 are the remaining ordered delivery sequence.
...
| V3.14 | For AI redesign                   | NEXT     | V3.8–V3.10, V3.13       |
